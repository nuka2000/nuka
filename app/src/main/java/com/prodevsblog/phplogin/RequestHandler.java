...
public class RequestHandler {
    ...
    public String sendGetRequestParam(String requestURL, String query){
        StringBuilder sb =new StringBuilder();
        try {
    ...
    public String CheckConnection(String requestURL){
        StringBuilder sb =new StringBuilder();
        try {
...
//    public static String sendKamu(String test, String test1){
//
//        return test;
//    }
}
